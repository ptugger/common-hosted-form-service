  ...
  static get jsonSchema() {
    return {
      ...
      properties: {
        ...
        schEnabled: { type: 'boolean' },
        schType: { type: ['string', 'null'], minLength: 1, maxLength: 255 },
        schOpenSubmissionDateTime: { type: ['string', 'null'] },
        schCloseSubmissionDateTime: { type: ['string', 'null'] },
        schClosingMessageEnabled: { type: 'boolean' },
        schClosingMessage: { type: ['string', 'null'], minLength: 1, maxLength: 255 },
        schKeepOpenForTerm: { type: ['string', 'null'], minLength: 1, maxLength: 255 },
        schKeepOpenForInterval: { type: ['string', 'null'], minLength: 1, maxLength: 255 },
        schRepeatEnabled: { type: 'boolean' },
        schRepeatEveryTerm: { type: ['string', 'null'], minLength: 1, maxLength: 255 },
        schRepeatEveryIntervalType: { type: ['string', 'null'], minLength: 1, maxLength: 255 },
        schRepeatUntil: { type: ['string', 'null'] },
        schLateSubmissionsEnabled: { type: 'boolean' },
        schLateSubmissionsForNextTerm: { type: ['string', 'null'], minLength: 1, maxLength: 255 },
        schLateSubmissionsForNextInterval: { type: ['string', 'null'], minLength: 1, maxLength: 255 },
